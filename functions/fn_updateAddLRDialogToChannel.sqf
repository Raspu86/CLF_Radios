/*
 	Name: CLF_fnc_updateADLRDialogToChannel
...
if ((TF_lr_dialog_radio call TFAR_fnc_getAdditionalLrChannel) > 0) then {ctrlSetText [LR_AD_EDIT, [TF_lr_dialog_radio, (TF_lr_dialog_radio call TFAR_fnc_getAdditionalLrChannel) + 1] call TFAR_fnc_GetChannelFrequency];};
